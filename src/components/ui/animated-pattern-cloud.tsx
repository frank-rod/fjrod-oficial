 ...
 */
const AnimatedPatternCloud: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Color Palette
        vec3 baseColor = vec3(0.02, 0.04, 0.14); // Dark Navy Blue
  ...
  return (
    <div className="absolute inset-0 w-full h-full bg-[#030712] -z-10">
      <canvas
        ref={canvasRef}
...
export default AnimatedPatternCloud;
